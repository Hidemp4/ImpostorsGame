                    ...
                    <DialogContent className="flex flex-col w-full h-screen">
                        <div className="mt-10 space-y-4">
                            ...
                            <DialogHeader>
                                ...
                                <span className="text-[#00d862]">Jogadores - 1</span>
                            </DialogHeader>
                        </div>
                        ...
                        <div className="w-full h-full flex-1">
                            ...
                            <div className="flex gap-2 items-center">
                                <div className="flex flex-1 justify-between bg-[#1b1b27] px-3 py-4 rounded-xl items-center">
                                    <div className="flex space-x-4 pl-2 items-center">
                                        ...
                                        <p className="text-white font-semibold text-lg tracking-wide">Hideki</p>
                                    </div>

                                    <Button className="bg-transparent hover:bg-transparent focus:ring-0 cursor-pointer flex text-[#5e5e68]" size="sm">
                                ...
                                <Button className="bg-transparent hover:bg-transparent focus:ring-0 cursor-pointer flex text-[#ff1a40] pb-1" size="sm">
                        ...
                        <div className="absolute bottom-0 left-0 w-full">
                            <DialogFooter>
                                ...
                                <div className="flex items-center w-full">
                                    ...
                                    <Button className={`bg-transparent hover:bg-transparent focus:ring-0 cursor-pointer flex text-[#00d862]`}>
